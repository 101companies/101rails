...
//var editor = "theeditor"; // This should be the id of your editor element.
var lang = "en_US";
var dicPath = "../assets/en_US.dic";
var affPath = "../assets/en_US.aff.txt";
...
function spell_check(id) {
  ...
  var session = ace.edit(id).getSession();
...
function enable_spellcheck(id) {
  console.log("Got there.")
  contents_modified = true;
  ace.edit(id).getSession().on('change', function(e) {
    contents_modified = true;
  });
  spell_check(id);
  setInterval(function() {spell_check(id)}, 300);
}
